...
contract CollanoteToken is IERC20Token, owned{

	/* Public variables of the token */
	string public standard = "Collanote token v1.0";
	string public name = "Collanote";     
	...
	function CollanoteToken(address _icoAddress) {
